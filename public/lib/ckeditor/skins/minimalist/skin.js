...
CKEDITOR.skin.chameleon = (function() {
    ...
    var colorBrightness = (function() {
            function channelBrightness(channel, ratio) {
                return ('0' + (ratio < 0 ?
                    0 | channel * (1 + ratio) :
                    0 | channel + (255 - channel) * ratio).toString(16)).slice(-2);
            }
    ...
    return function(editor, part) {
        var uiColor = editor.uiColor,
            ...
            templateStyles = {
                ...
                defaultGradient: verticalGradient(uiColor, uiColor),
                lightGradient: verticalGradient(colorBrightness(uiColor, 0.7), colorBrightness(uiColor, 0.7)),
                mediumGradient: verticalGradient(colorBrightness(uiColor, 0.8), colorBrightness(uiColor, 0.8)),

                // These are for specific UI elements.
                ckeButtonOn: verticalGradient(colorBrightness(uiColor, 0.7), colorBrightness(uiColor, 0.7)),
